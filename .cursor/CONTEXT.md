...
| 日期 | 版本 | 環境 | 更新內容 | 部署者 |
|------|------|------|----------|--------|
| 2026-02-09 | v0.6.40 | 測試 | 打卡無狀態不顯示、備註欄位(班表H/打卡J/校正J)、查詢更新備註、比對校正備註 | AI |
| 2026-02-09 | v0.6.39 | 測試 | 工作時數分鐘依 start/end 實際計算（方案 B） | AI |
| 2026-02-09 | v0.6.38 | 測試 | 前端工作時數改為「n.m 小時 (iii 分)」顯示格式 | AI |
...
*最後更新：2026-02-09（v0.6.40 備註欄位與查詢更新備註）*
